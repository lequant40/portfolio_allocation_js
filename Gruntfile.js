module.exports = function(grunt) {
  ...
  grunt.initConfig({
	...
	concat: {
	  portfolio_allocation: {
	    src: ['lib/header.js', 'lib/matrix/matrix.js', 'lib/matrix/vector.js', 'lib/allocation/*.js', 'lib/footer.js'],
	...
	qunit: { 
      dev: ['test/index_matrix.html', 'test/index_vector.html', 'test/index_allocation_dev.html'],
